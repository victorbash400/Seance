...
const Page = ({ children, ...props }: any) => {
  return (
    <div
      className="custom-page relative overflow-hidden bg-amber-50 p-8 h-full border border-amber-200"
      {...props}
    >
      {/* left edge shadow */}
      <div
...
const FlipBook = forwardRef<FlipBookRef, FlipBookProps>(
  ({ children, onFlip, onChangeState, onInit, className = "" }, ref) => {
