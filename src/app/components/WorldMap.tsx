  ...
  return (
    <div className="w-full h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-black/90 to-transparent z-40 flex items-center justify-center">
        ...
        <p
          className="text-xl text-orange-400 font-serif tracking-wide font-medium paint-font px-6 py-3"
          style={{
            textShadow:
              "0 0 20px rgba(255, 165, 0, 0.8), 0 0 40px rgba(255, 165, 0, 0.4)",
              ...
              geographies.map((geo) => {
                ...
                return (
                  <Geography
                    ...
                    onClick={(event) => {
                      console.log(
                        `Geography clicked: ${geoName}, isHighlighted: ${isHighlighted}`,
                      ); // Debug
                      if (isHighlighted) {
                        const country = countryMarkers.find(
                          (c) => c.geoName === geoName,
                        );
                        if (country) {
                          ...
                          console.log(
                            `Country not found for geoName: ${geoName}`,
                          ); // Debug
                        }
                      } else {
